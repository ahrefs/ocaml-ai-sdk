...
let test_developer_message () =
  let msgs =
    [ Ai_provider.Prompt.System { content = "Instructions"; provider_options = Ai_provider.Provider_options.empty } ]
  in
...
let test_remove_system_message () =
  let msgs =
    [ Ai_provider.Prompt.System { content = "Ignored"; provider_options = Ai_provider.Provider_options.empty } ]
  in
